    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <aside className="w-64 border-r border-white/10 p-6 flex flex-col gap-8 hidden md:flex">
        ...
        <nav className="flex-1 space-y-2">
          <Link href="/admin" className="flex items-center gap-3 px-4 py-3 bg-fanx-primary/10 text-fanx-primary rounded-xl font-bold transition-all">
            <Activity size={20} /> Dashboard
          </Link>
          <Link href="/admin/users" className="flex items-center gap-3 px-4 py-3 text-gray-400 hover:bg-white/5 hover:text-white rounded-xl font-medium transition-all">
            <Users size={20} /> Users
          </Link>
          <Link href="/admin/sessions" className="flex items-center gap-3 px-4 py-3 text-gray-400 hover:bg-white/5 hover:text-white rounded-xl font-medium transition-all">
            <Video size={20} /> Live Sessions
          </Link>
          <Link href="/admin/revenue" className="flex items-center gap-3 px-4 py-3 text-gray-400 hover:bg-white/5 hover:text-white rounded-xl font-medium transition-all">
            <DollarSign size={20} /> Revenue
          </Link>
          <Link href="/admin/security" className="flex items-center gap-3 px-4 py-3 text-gray-400 hover:bg-white/5 hover:text-white rounded-xl font-medium transition-all">
            <ShieldAlert size={20} /> Security
          </Link>
        </nav>

        <div className="pt-6 border-t border-white/10 space-y-2">
          <Link href="/admin/settings" className="flex items-center gap-3 px-4 py-3 text-gray-400 hover:bg-white/5 hover:text-white rounded-xl font-medium transition-all">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <header className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-gray-400 font-medium">Platform overview and real-time analytics.</p>
          </div>
          <div className="flex gap-4">
            <div className="px-6 py-3 glass-pane border border-white/10 rounded-2xl flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="p-6 glass-pane border border-white/10 rounded-2xl">
              ...
              <div className="space-y-4 font-mono text-xs">
                ...
                <div className="flex gap-4 text-gray-500 border-l-2 border-white pl-4">
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 glass-pane border border-white/10 rounded-2xl h-[400px] flex flex-col">
              ...
              <div className="flex-1 flex flex-col gap-4">
                ...
                <SessionRank name="Tiwa Savage" fans="3.1k" color="bg-white" width="45%" />
...
function StatCard({ title, value, change, icon }: { title: string, value: string, change: string, icon: React.ReactNode }) {
  return (
    <div className="p-6 glass-pane border border-white/10 rounded-2xl space-y-4">
      ...
      <div>
        ...
        <div className="text-xs font-bold text-green-500 mt-1">{change} <span className="text-gray-500 ml-1">vs last 24h</span></div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-between text-xs font-bold">
        <span>{name}</span>
        <span className="text-gray-400">{fans} fans</span>
      </div>
